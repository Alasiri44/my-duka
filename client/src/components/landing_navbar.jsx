...
import MyDukaLogoFull from "../assets/MyDukaLogoFull.png";

function LandingNavBar() {
    return (
        <div className="relative py-4 px-6 md:px-8 flex justify-between items-center bg-white bg-opacity-90 shadow-md sticky top-0 z-50 backdrop-blur-sm">
            {/* Logo on the far left */}
            <NavLink to='/'>
                <img src={MyDukaLogoFull} alt="Duka Smart logo" width={150} />
            </NavLink>
